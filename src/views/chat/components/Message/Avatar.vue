...
<template>
  <img v-if="image" src="http://120.78.136.2/note/logo.png" class="object-cover w-full h-full " alt="avatar">
  <span v-else class="text-[27px]">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" width="1em" height="1em" style="background:white">
